...
function carosoul() {
	...
	var  doIndex = 0;
	var speed = -10;
	var bannerCarosoul = document.querySelector('.baner-cursoal')
	var carosoalSlide = document.querySelector(".carosoal-slide")
	var carosoalTmg = document.querySelectorAll('.baner-cursoal img')
	
	var aBut = document.querySelectorAll(".carosoul-btn");
...
/*	countDownHtml()
	...
	function countDownHtml() {
		//倒计时
		var countDownTime = countDown('2019-9-10 16:36:00')
